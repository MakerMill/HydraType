...
final class InlineLazyWriterHydrator implements WriterLifecycleHydrator
{
    ...
    private function createCamelWriter(): Closure
    {
        return Closure::bind(
    ...
    private function createSnakeWriter(): Closure
    {
        return Closure::bind(
            static function (WriterLifecycleTarget $object, array $data): void {
                $object->id = $data['id'];
    ...
    private function writerFor(array $data): Closure
    {
        if (array_key_exists('userName', $data)) {
            return $this->camelWriter ??= $this->createCamelWriter();
        }
        if (array_key_exists('user_name', $data)) {
            return $this->snakeWriter ??= $this->createSnakeWriter();
        }
